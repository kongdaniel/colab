...
def parse_args():
    ...
    parser.add_argument('--bin_path', default='E:\paperwork\MobileFaceNet_Tensorflow\MobileFaceNet_TF\datasets\\faces_ms1m_112x112\\train.rec', type=str,
                        help='path to the binary image file')
    parser.add_argument('--idx_path', default='E:\paperwork\MobileFaceNet_Tensorflow\MobileFaceNet_TF\datasets\\faces_ms1m_112x112\\train.idx', type=str,
